...
case class EntityCreated(ent: EntityManager) extends Event
case class EntityChanged(ent: EntityManager) extends Event
case class EntityRemoved(ent: EntityManager) extends Event
case class ComponentRemoved(ent: EntityManager, comp: Component) extends Event
case class ComponentAdded(ent: EntityManager, comp: Component) extends Event
